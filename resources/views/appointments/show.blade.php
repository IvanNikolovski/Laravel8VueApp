...
<div class="d-flex justify-content-center">
    <form action="/appointments/update/{{$appointment->id}}" method="post">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control @error('patient_name') is-invalid @enderror" id="specId" name="patient_name" value="{{$appointment->patient_name}}">
            </div>
            @error('patient_name')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="datetime-local" class="form-control @error('time_from') is-invalid @enderror" id="inst" name="time_from" required 
                value="{{ date('Y-m-d\TH:i', strtotime($appointment->time_from)) }}">
            </div>
            @error('time_form')
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="datetime-local" class="form-control @error('time_to') is-invalid @enderror" id="inst" name="time_to" required 
                value="{{ date('Y-m-d\TH:i', strtotime($appointment->time_to)) }}">
            </div>
            @error('time_to')
