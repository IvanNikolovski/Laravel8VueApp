<template>
  <div class="d-flex justify-content-center">
    <form @submit.prevent="addDoctor">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input
              ...
              v-model="speciality"
            />
            <div v-if="errors && errors.speciality" class="text-danger">{{ errors.speciality[0] }}</div>          </div>
      ...
      <input type="text" class="btn btn-primary" @click="addDoctor" placeholder="add"/>
